...
The course provides students with an introduction to research across all fields of computer science. It explores recent research advances, gives students practice on how to read and analyze scientific literature in different sub-areas. It provides mentoring and guidance on how to conduct novel research, from writing academic research proposals, design and method development to empirical evaluation, and from writing research papers. The class meets once per week for a 65-minute session. 
...
<p><strong>Course administration:</strong></br> All the discussions and the extra handouts are available on [Piazza](https://piazza.com/northeastern/spring2024/cs4950). Please do not send email.</br> 
