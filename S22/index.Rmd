...
<h2>Tue 10:25am-11:30am, Richards Hall 160 and/or Zoom</h2>
...
Office hours: Tue 12.30-1.30pm, or by appointment. 177 Huntington Ave, 9th floor.

<p><strong>Course description:</strong></br>
The course provides students with an introduction to research across all fields of computer science. It explores recent research advances in these fields, gives students practice on how to read and analyze scientific literature in different sub-areas, and provides mentoring and guidance on how to conduct novel research in these fields. The course also provides students with an overview of how research is conducted, from design to method development to empirical evaluation, and from writing research papers to writing academic research proposals. The class meets once per week for a 65-minute session. 

The prerequisite is CS3950, or permission of the instructor.
...
**Reading and discussing papers or presentations** The majority of the course will consist of summarizing research papers.</br> 
**Projects** The students will conduct a semester-long research project, individually or in a group.</br>
...
<p><strong>Course administration:</strong></br> All the discussions and the extra handouts are available on [Piazza](http://www.piazza.com/northeastern/spring2022/cs4950/). Please do not send email.</br> 
...
The final grade is based on a total of 100 points. The sum of all the attendance and participation points will be scaled to the maximum of 30. The sum of all the homeworks points will be scaled to the maximum of 30, and the project will be scaled to the maximum of 40. The scaled points will be added, and the final letter grades will follow the usual scale:</br>
